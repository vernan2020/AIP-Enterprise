...
from aip.tools.reconcile_portfolio_valuation import (
    _print_difference_rows,
    main,
)
...
def test_reconcile_portfolio_valuation_cli_writes_csv_and_reports_summaries(
    ...
    completed = subprocess.run(
        [
            sys.executable,
            "-m",
            "aip.tools.reconcile_portfolio_valuation",
            "--output",
            str(output_path),
        ],
        check=False,
