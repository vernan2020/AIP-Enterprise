...
def test_institutional_currency_normalization_handles_usd_and_crc_variants() -> None:
    positions = [
        ...
        },
        {
            ...
            "market_value": Decimal("100"),
            "classification": "active",
            "portfolio_yield": Decimal("4"),
            "nominal_rate": Decimal("3"),
        },
        {
            "currency": "colon",
            "market_value_crc": Decimal("100"),
            "market_value": Decimal("100"),
            "classification": "active",
            "portfolio_yield": Decimal("6"),
            "nominal_rate": Decimal("5"),
        },
        {
            "currency": "colones",
            "market_value_crc": Decimal("100"),
            "market_value": Decimal("100"),
            "classification": "active",
            "portfolio_yield": Decimal("7"),
            "nominal_rate": Decimal("6"),
        },
        {
            "currency": "CRC",
            "market_value_crc": Decimal("100"),
            "market_value": Decimal("100"),
            "classification": "active",
            "portfolio_yield": Decimal("8"),
            "nominal_rate": Decimal("7"),
        },
    ]
