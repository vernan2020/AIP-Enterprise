...
def test_decimal_precision_is_preserved_across_pricing_and_relative_value(treasury_instrument, yield_curve, analysis_request) -> None:
    ...
    assert relative_value_result.theoretical_price == pricing_result.market_value + (relative_value_result.nominal_spread * Decimal("100000"))
