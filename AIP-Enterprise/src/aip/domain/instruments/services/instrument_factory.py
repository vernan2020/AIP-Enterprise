...
class InstrumentFactory:
    ...
    def create(
        ...
        **kwargs: Any,
        ...
        if instrument_type == InstrumentType.GOVERNMENT_BOND:
            return GovernmentBond(
                isin=isin or "US0000000000",
                name=name,
                issuer=issuer or Issuer(code="ISSUER", name="Issuer", issuer_type=__import__("aip.domain.instruments.issuers.issuer_type", fromlist=["IssuerType"]).IssuerType.GOVERNMENT),
                currency=currency,
                ...
                coupon_schedule=kwargs.get("coupon_schedule", CouponSchedule()),
                ...
                payment_frequency=kwargs.get("payment_frequency", __import__("aip.domain.instruments.enums.payment_frequency", fromlist=["PaymentFrequency"]).PaymentFrequency.SEMIANNUAL),
                coupon_type=kwargs.get("coupon_type", __import__("aip.domain.instruments.enums.coupon_type", fromlist=["CouponType"]).CouponType.FIXED),
                amortization_type=kwargs.get("amortization_type", __import__("aip.domain.instruments.enums.amortization_type", fromlist=["AmortizationType"]).AmortizationType.BULLET),
                settlement_currency=kwargs.get("settlement_currency", currency),
            )
        if instrument_type == InstrumentType.TREASURY_BILL:
            return TreasuryBill(
        ...
        if instrument_type == InstrumentType.ZERO_COUPON_BOND:
            return ZeroCouponBond(
                ...
                coupon_rate=kwargs.get("coupon_rate", Decimal("0.05")),
                payment_frequency=kwargs.get("payment_frequency", __import__("aip.domain.instruments.enums.payment_frequency", fromlist=["PaymentFrequency"]).PaymentFrequency.SEMIANNUAL),
                coupon_type=kwargs.get("coupon_type", __import__("aip.domain.instruments.enums.coupon_type", fromlist=["CouponType"]).CouponType.ZERO),
                amortization_type=kwargs.get("amortization_type", __import__("aip.domain.instruments.enums.amortization_type", fromlist=["AmortizationType"]).AmortizationType.BULLET),
                settlement_currency=kwargs.get("settlement_currency", currency),
            )
        if instrument_type == InstrumentType.FLOATING_RATE_BOND:
            return FloatingRateBond(
                ...
                payment_frequency=kwargs.get("payment_frequency", __import__("aip.domain.instruments.enums.payment_frequency", fromlist=["PaymentFrequency"]).PaymentFrequency.QUARTERLY),
                coupon_type=kwargs.get("coupon_type", __import__("aip.domain.instruments.enums.coupon_type", fromlist=["CouponType"]).CouponType.FLOATING),
                amortization_type=kwargs.get("amortization_type", __import__("aip.domain.instruments.enums.amortization_type", fromlist=["AmortizationType"]).AmortizationType.BULLET),
                settlement_currency=kwargs.get("settlement_currency", currency),
        ...
        if instrument_type == InstrumentType.INVESTMENT_FUND:
        ...
        if instrument_type == InstrumentType.CERTIFICATE_OF_DEPOSIT:
        ...
        if instrument_type == InstrumentType.COMMERCIAL_PAPER:
        ...
        if instrument_type == InstrumentType.REPO:
            return Repo(
        ...
        if instrument_type == InstrumentType.REVERSE_REPO:
            return ReverseRepo(
