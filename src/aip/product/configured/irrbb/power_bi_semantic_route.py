...
_CANONICAL_SEMANTIC_SOURCES = {
    ...
    IRRBBPhysicalSourceSegment.CAPTACIONES: CAPTACIONES_SEMANTIC_MODEL_SOURCE,
}
...
class PowerBISemanticModelRoute:
    ...
    def execute_dax_queries_url(self) -> str:
        ...
        if self.workspace_id is None:
            return f"{_POWER_BI_API_ORIGIN}/v1.0/myorg/datasets/{self.dataset_id}/executeDaxQueries"
        return (
            f"{_POWER_BI_API_ORIGIN}/v1.0/myorg/groups/{self.workspace_id}"
