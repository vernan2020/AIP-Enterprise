...
class HQLAExplanation:
    ...
    def build(self, classification: str, score: Decimal, reason: str, assumptions: tuple[str, ...], warnings: tuple[str, ...], references: tuple[str, ...]) -> Explanation:
        factors = [
            ExplanationFactor(name="hqla_score", value=score, direction="higher_is_better", contribution=score, source_reference="hqla"),
        ]
