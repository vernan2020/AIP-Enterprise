...
def nelson_siegel_zero_rate(
    tenor: Decimal, *, beta0: Decimal, beta1: Decimal, beta2: Decimal, tau: Decimal
) -> Decimal:
    if tau <= 0:
...
def nelson_siegel_curve(
    tenors: list[Decimal], *, beta0: Decimal, beta1: Decimal, beta2: Decimal, tau: Decimal
) -> list[Decimal]:
    return [
        nelson_siegel_zero_rate(tenor, beta0=beta0, beta1=beta1, beta2=beta2, tau=tau)
        for tenor in tenors
    ]
